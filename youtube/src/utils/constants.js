...
export const YOUTUBE_VIDEO_INFO = 'https://youtube.googleapis.com/youtube/v3/videos?part=snippet,statistics&id='

export const YOUTUBE_CHANNEL_INFO = 'https://youtube.googleapis.com/youtube/v3/channels?part=snippet&id='

export const YOUTUBE_COMMENTS = 'https://youtube.googleapis.com/youtube/v3/comments?part=snippet&videoId='